...
namespace random
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int SideA = rand.Next(1, 11);
            int SideB = rand.Next(1, 11);
            Console.WriteLine("The first side is " + SideA + ".");
            Console.WriteLine("The second side is " + SideB + ".");
            Console.WriteLine("The area of the rectangle is " + (SideA * SideB));
            Console.WriteLine("The diagonal of the rectangle is " + Math.Sqrt(Math.Pow(SideA,2) + Math.Pow(SideB,2)));
            Console.Read();
